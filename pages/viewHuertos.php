...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      <nav>
        <ul>
          ...
          <li><a href="infoPlantas.html">Info Plantas</a></li>
          <li><a href="viewHuertos.php" class="active">Administra Huertos</a></li>
    ...
    <form method="post">
      ...
      -->
      <input type="submit" name="Regar"
                class="button" value="Regar" />
    </form>
